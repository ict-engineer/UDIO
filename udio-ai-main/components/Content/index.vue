  ...
  <section class="p-4 text-center my-32">
    <div class="container mx-auto shadow-2xl rounded my-12">
      <div class="w-full p-2 m-2">
        ...
        <div class="p-2 m-2">
          <p>Move your Point of Sales to digital channels and reach customers anywhere and anytime. Enable customers to approve transactions on the go with remote sign on mobile devices.</p>
        </div>
      </div>
      <div class="flex justify-around items-center">
        <button class="flex items-center bg-udio-blue-900 py-2 px-8 m-4 font-bold shadow">
          <div class="pr-2">
            More
          </div>
